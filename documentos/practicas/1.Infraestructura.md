...
[editar este fichero enlazando el último commit ](https://github.com/JJ/clases-CC-2015-16/practicas/1.md) en el
que se indique claramente la dirección donde se ha subido el
...
puede indicar en el propio README del mismo. 
