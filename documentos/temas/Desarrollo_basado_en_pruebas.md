...
funcionalidades. Si se quiere hacer con cualquier otra aplicación,
también es válido.

Se puede hacer un ejercicio equivalente, siempre que tenga operaciones
similares: creación, listado, borrado, ciclo CRUD básico. El objetivo
de este ejercicio es poner en práctica lo que viene a continuación, NO
es un objetivo de la asignatura.
...
[*PaaS*, plataformas como servicio](PaaS.md), donde se exolica cómo se
...
[*contenedores*](Contenedores.md), que es el siguiente en el temario
de la asignatura.
