...
aspectos: configuración, rutas y middleware. Los principios generales
de configuración en la nube se han visto
en [este tema](Configuracion_microservicios.md).
...
En el [siguiente tema](PaaS.md) veremos cómo hacer efectivamente el
