...
que se planteen y *organizar los hitos*
...
Esta última es esencial, porque encierra la *lógica de negocio* del mismo y por
tanto será esencial para cualquier desarrollo posterior. Aunque rara vez será la
...
un número de historias que nos lleven a una solución mínimamente viable del
mismo, y que sea desplegable en la nube. Esas historias de usuario,
además, deberán estar acompañadas de documentación (u otras historias) que definan claramente
...
compra estén también bien definidas. En particular, en el caso "lista
...
1. 3 puntos: Historias de usuario correctas, asignadas correctamente a un hito,
   y preparadas para trabajar con ellas.
2. 4 puntos: Hitos que describan correctamente un producto mínimamente viable,
   que se vaya elaborando por orden, y con HUs alineadas con las mismos
