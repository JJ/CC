...
Hito 3º: Automatización  de la creación máquinas virtuales
=====================================
...
El script de aprovisionamiento tendrá que llamarse `up.sh`. La máquina
...
>Se hará constar el nombre del DNS de la máquina, no el URL porque en principio no se
>pide que se despliegue ningún servicio web. 

Se recuerda que el `README.md` es la descripción del proyecto; por
eso, deberá incluir una descripción general del proyecto,  las instrucciones para configurar la máquina
